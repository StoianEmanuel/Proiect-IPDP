...
# Aplicarea transformării polinomiale pe caracteristici
poly_features = PolynomialFeatures(degree=25) # Setează gradul polinomului dorit
X_train_poly = poly_features.fit_transform(X_train)
X_test_poly = poly_features.transform(X_test)

# Crearea și antrenarea modelului de regresie polinomială
...
joblib.dump(regressor, './ML/model_regresie_liniara2.pkl')  # Salvare într-un fișier
