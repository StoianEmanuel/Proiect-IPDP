...
lin_int_col  = [0, 1, 2]        # Specify columns that will be transformed into int
poly_int_col = [0, 2, -1]
...
print('''Predictii (dataframe):\n' Release Year | Transistors (millions) | Process Size (nm) | TDP (W) | Core Base Clock (GHz) | 
Core Boost Clock (GHz) | Memory Bandwidth (GB/s) | 'Shading Units | Memory Size (GB) | Memory Clock Speed (MHz) | Launch Price ($)\n''')
