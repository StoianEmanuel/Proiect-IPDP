...
columns = ['Release Year', 'Process Size (nm)', 'TDP', 'Base Clock', 'Boost Clock', 'L1 Cache Size', 'L2 Cache Size',
            'Number of Cores', 'Number of Threads', 'System Memory Frequency', 'Launch Price ($)']
...
L1 Cache Size (GB) | L2 Cache Size (GB) | Number of Cores | Number of Threads | System Memory Frequency (MHz) | Launch Price ($)\n''')
