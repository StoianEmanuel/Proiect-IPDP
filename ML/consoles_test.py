...
from utils import predicition, get_scores, add_boost, get_df, fill_with_mean_column

def consoles_prediction(year = [], database_path = '', linear_regressor_path = None, polynomial_regressor_path = None):
